...
You need to have a {lv} 2024 version to open the material provided in this course.
...
Download the https://labviewcommunitytraining.github.io/labview-events-course/course-material.zip[course material zip] to start seting up the course
